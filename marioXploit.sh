...
echo $red" harap sabar menunggu ya ngentod :)"   
sleep 1
echo '''\a
\033[34;1m               _
\033[34;1m              / |
...
echo
echo $cy"==================="$pur" ==================="
echo $me" █"$bi"  Author  :  marioXploit   "$me"            █"
...
echo $cy"⟨"$pu"16"$cy"⟩"$bi"-» bot reaction fb"
echo $cy"⟨"$pu"17"$cy"⟩"$bi"-» nik dan kk gratis"
echo $cy"⟨"$pu"18"$cy"⟩"$bi"-» Keluar"
echo
echo $pu"╭─["$i"Pilih sesuai ke inginan Anda tod"$pu"]"
read -p"╰─> : " pil
...
sleep 2
echo $i"Silahkan lu pakai eaa ngentod semoga bermanfaat"
sleep 2
echo $i"Buat kalian ngentod²"
sleep 2
echo $i"Bila lu belum mengerti Bisa Nanya"
echo $i"Melalui Via:"
sleep 2
echo $ku"Facebook :"$pur" zet ex wazaowsky"
echo $ku"Facebook :"$pur" Fikri Fahrizal"
echo $ku"WhatsApp :"$pur" 089639546159"
sleep 2
echo $i"dan jangan lupa "$cy"BANTU SHARE EAA"
sleep 2
echo $i"website "$cy" www.marioxploit.home.blog"
sleep 2
echo $i"Agar tambah bikin tools baru lagi"
sleep 2
exit
fi
